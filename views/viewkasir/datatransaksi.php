            ...
            $datatransaksi = $objtran->getdata();           
              foreach ($datatransaksi as $key) {
                ...
                <tr>
                  ...
                  <td>
                  <a class="btn btn-social-icon" href="detailtransaksi.php?idtransaksi=<?php echo $key['ID_TRANSAKSI'] ;?>&idpesan=<?php echo $key['ID_PESAN'] ;?>"><i class="fa fa-play p-2 "></i></a>
                </td>
                </tr>
